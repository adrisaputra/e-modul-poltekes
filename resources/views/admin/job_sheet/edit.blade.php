...
<section class="content-header">
	...
	<div class="box">
		...
		<form action="{{ url('/'.Request::segment(1).'/edit/'.$job_sheet->id) }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
		{{ csrf_field() }}
			...
			<div class="box-body">
				<div class="col-lg-12">
					...
					<div class="form-group @if ($errors->has('judul')) has-error @endif">
						<label class="col-sm-2 control-label">{{ __('Judul Job Sheet') }} <span class="required" style="color: #dd4b39;">*</span></label>
						<div class="col-sm-10">
							...
							<input type="text" class="form-control" placeholder="Judul Job Sheet" name="judul" value="{{ $job_sheet->judul }}" >
						</div>
					</div>
