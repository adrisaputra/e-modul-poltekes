...
<section class="content-header">
	...
	<div class="box">
		...
		<form action="{{ url('/'.Request::segment(1).'/edit/'.$mahasiswa->id) }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
		{{ csrf_field() }}
			...
			<div class="box-body">
				...
				<div class="form-group @if ($errors->has('nim')) has-error @endif">
						...
						<div class="col-sm-10">
							...
							<input type="text" class="form-control" placeholder="NIM" name="nim" value="{{ $mahasiswa->nim }}" >
						</div>
					</div>
					...
					<div class="form-group @if ($errors->has('alamat')) has-error @endif">
						...
						<div class="col-sm-10">
							...
							<input type="text" class="form-control" placeholder="Alamat" name="alamat" value="{{ $mahasiswa->alamat }}" >
						</div>
					</div>
					...
					<div class="form-group @if ($errors->has('no_hp')) has-error @endif">
						...
						<div class="col-sm-10">
							...
							<input type="text" class="form-control" placeholder="No. HP" name="no_hp" value="{{ $mahasiswa->no_hp }}" >
						</div>
					</div>
					...
					<div class="form-group @if ($errors->has('kelas_id')) has-error @endif">
                            ...
                            <div class="col-sm-10">
                                ...
                                <select class="form-control select2" name="kelas_id">
                                    ...
                                    @foreach($kelas as $v)
                                    	<option value="{{ $v->id }}" @if($mahasiswa->kelas_id=="$v->id" ) selected @endif>{{ $v->kelas }}</option>
                                    @endforeach
