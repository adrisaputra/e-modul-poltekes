...
<section class="content-header">
	...
	<div class="box">
		...
		<form action="{{ url('/'.Request::segment(1).'/edit/'.$post_test->id) }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
		{{ csrf_field() }}
			...
			<div class="box-body">
				...
				<div class="form-group @if ($errors->has('judul')) has-error @endif">
						...
						<div class="col-sm-10">
							...
							<input type="text" class="form-control" placeholder="Judul" name="judul" value="{{ $post_test->judul }}" >
						</div>
					</div>
					...
					<div class="form-group @if ($errors->has('url')) has-error @endif">
						...
						<div class="col-sm-10">
							...
							<input type="text" class="form-control" placeholder="Link" name="url" value="{{ $post_test->url }}" >
						</div>
					</div>
