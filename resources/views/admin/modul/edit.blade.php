			...
			<div class="box-body">
				<div class="col-lg-12">
					...
					<div class="form-group @if ($errors->has('file')) has-error @endif">
					   ...
					   <div class="col-sm-9">
						@if ($modul->file)
							<span class="text-red">file sebelumnya: </span><a href="{{ asset('upload/modul/' . $modul->file) }}">{{ $modul->file }}</a>
						@endif  
					...
					<div class="form-group @if ($errors->has('gambar')) has-error @endif">
						...
						<div class="col-sm-9">
						@if ($modul->gambar)
							<span class="text-red">gambar sebelumnya: </span><a href="{{ asset('upload/modul/' . $modul->gambar) }}">{{ $modul->gambar }}</a>
						@endif  
						@if ($errors->has('gambar'))<label class="control-label" for="inputError"><i class="fa fa-times-circle-o"></i> {{ $errors->first('gambar') }}</label>@endif
