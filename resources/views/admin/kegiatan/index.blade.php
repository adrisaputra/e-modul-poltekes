...
<div class="content-wrapper">
	...
	<div class="box">   
			...
			<div class="table-responsive box-body">
				...
				<table class="table table-bordered">
					<tr style="background-color: gray;color:white">
						...
						<th style="width: 75%">Nama Kegiatan</th>
					...
					<tr>
						...
						<td>{{ $v->nama }}</td>
						<td><a href="{{ url('/'.Request::segment(1).'/edit/'.$v->id ) }}" class="btn btn-xs btn-flat btn-warning">Edit</a>
		...
		<div class="box-footer">
			<!-- PAGINATION -->
			<div class="float-right">{{ $kegiatan->appends(Request::only('search'))->links() }}</div>
		</div>
	</div>
	</section>
</div>
