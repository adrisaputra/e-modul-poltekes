				...
				<div class="col-lg-12">
					...
					<div class="form-group @if ($errors->has('kelas')) has-error @endif">
						...
						<div class="col-sm-10">
							...
							<input type="text" class="form-control" placeholder="Kelas" name="kelas" value="{{ old('kelas') }}" >
						</div>
					</div>
					...
					<div class="form-group @if ($errors->has('nama_dosen')) has-error @endif">
						...
						<div class="col-sm-10">
							...
							<input type="text" class="form-control" placeholder="Nama Dosen" name="nama_dosen" value="{{ old('nama_dosen') }}" >
						</div>
					</div>
					...
					<div class="form-group @if ($errors->has('ruangan')) has-error @endif">
						...
						<div class="col-sm-10">
							...
							<input type="text" class="form-control" placeholder="Ruangan" name="ruangan" value="{{ old('ruangan') }}" >
						</div>
					</div>
